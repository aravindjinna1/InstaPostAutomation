...
/**
 * Uploads a base64-encoded VIDEO (generated by videoService) to Cloudinary
 * and returns a public URL. Instagram Reels require a public video_url.
 */
async function uploadVideoToCloudinary({ base64Data, mimeType }) {
  try {
    const dataUri = `data:${mimeType};base64,${base64Data}`;

    const result = await cloudinary.uploader.upload(dataUri, {
      folder: "ig-auto-poster/reels", // organize reels separately
      resource_type: "video", // MUST be "video" for videos
    });
